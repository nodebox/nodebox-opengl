...
static PyObject *
bezier_math_linepoint(PyObject *self, PyObject *args)
{
...
static PyObject *
bezier_math_linelength(PyObject *self, PyObject *args)
{
    double x0, y0, x1, y1;
    double out_length;
...
static PyObject *
bezier_math_curvepoint(PyObject *self, PyObject *args)
{
...
static PyObject *
bezier_math_curvelength(PyObject *self, PyObject *args)
{
...
static PyMethodDef bezier_mathMethods[] = {
    {"linepoint",  bezier_math_linepoint, METH_VARARGS, "Calculate linepoint."},
    {"linelength",  bezier_math_linelength, METH_VARARGS, "Calculate linelength."},
    {"curvepoint",  bezier_math_curvepoint, METH_VARARGS, "Calculate curvepoint."},
    {"curvelength",  bezier_math_curvelength, METH_VARARGS, "Calculate curvelength."},
...
initbezier_math(void)
{
    ...
    m = Py_InitModule("bezier_math", bezier_mathMethods);
